...
urlpatterns = [
    ...
    path('', index, name = "index"),#URL 추가 http://127.0.0.1:8000 주소로 접근시 vote 어플리케이션의
    #view인 index 함수를 호출 하도록 등록.
    #path('hello/', index),
    #url 등록시 파이썬 코드에서 URL을 외워서 사용하지 않고,
    ...
    #customlogin 폴더에 있는 urls.py에서 처리하도록 등록
